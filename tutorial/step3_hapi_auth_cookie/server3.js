  ...
  //register the plugins with the server
   ...
   // server.auth.strategy('strategy_name', 'scheme_name', options_object);
    ...
    var authCookieOptions = {
      password: 'cookie-encryption-password', //Password used for encryption - just needs to be a string
      cookie: 'sid', // Name of cookie to set
      isSecure: false,
    };
...
server.route(require("./routes_3.js"));
